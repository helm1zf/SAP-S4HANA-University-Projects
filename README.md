...
* Setting up the **Material Ledger** (using codes like OMX1 and OMX3) so that the finance side could actually talk to the warehouse side.

### 2. Running the Business Cycles
I spent a lot of time practicing the standard "demo" flows:
* **Buying side (Purchasing):** Creating Purchase Orders,  doing the Goods Receipt (MIGO), and checking the vendor invoices.
